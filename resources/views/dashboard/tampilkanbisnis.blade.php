...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Ubah Bisnis Senat</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="container">
        ...
        <div class="card">
        <div class="card-body">
          <form action="/ubahbisnis/{{$data->id}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                ...
                <input type="" name="isi" class="form-control" id="exampleFormControlInput1" placeholder="" value="{{$data->isi}}">
              </div>
              <div class="mb-3">
