...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">DAFTAR PERATURAN SENAT</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Peraturan Senat</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="container">
  <div class="card">
    <div class="card-body">
  <a class="btn btn-success mb-2 btn-sm" href="/tambahperaturan" role="button">Tambah Data</a>
    <div class="row">
        <table class="table table-bordered aligned">
            ...
            <tbody>
                ...
                <td>
                  <a href="/tampilkanperaturan/{{$row->id}}"  class="btn btn-warning btn-sm">Ubah</a>
                  <a href="/hapusperaturan/{{$row->id}}" class="btn btn-danger btn-sm">Hapus</a>
                </td>
